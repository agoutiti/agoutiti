...
<jsp:include page="../commom/TopMenu.jsp" flush="false"/>
...
<div class = "container">
	<form class= "form-horizontal" method="post" name="memInsForm" 
	    ...
	    <div class="form-group">
	    	...
	    	<div class = "col-sm-2"	>
	    		<input type ="text" class="form-control" id="id" name="id" maxlength="20" placeholder="ID"/>
	    	</div>
	    </div>  
	    
	    <div class="form-group">
	    	<label for ="pwd" class = "col-sm-3 control-label"> 비번</label>
	    	<div class = "col-sm-2"	>
	    		<input type ="pasword" class="form-control" id="pwd" name="pwd" maxlength="20" placeholder="비번"/>
	    	</div>
	    </div>  
	    
	    <div class="form-group">
	    	<label for ="repwd" class = "col-sm-3 control-label"> 비번 확인</label>
	    	<div class = "col-sm-2"	>
	    		<input type ="password" class="form-control" id="repwd" name="repwd" maxlength="20" placeholder="비번 확인"/>
	    	</div>
	    </div>  
	    ...
	    <div class="form-group">
	    	...
	    	<div class = "col-sm-2"	>
	    		<input type ="text" class="form-control" id="name" name="name" maxlength="20" placeholder="name"/>
	    	</div>
	    </div>  
	  ...
	  <div class="form-group">
			...
			<div class = "col-sm-2"	>
				<label class= "radio-inline">
					<input type="radio" id="register_Yn" name="register_Yn" value="Y" checked> YES&nbsp;&nbsp;
				</label>		
				<label class= "radio-inline">
					<input type="radio" id="register_Yn" name="register_Yn" value="N" > NO&nbsp;&nbsp;
				</label>		
		  </div>  
	  </div>  
